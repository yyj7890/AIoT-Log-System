...
public class EnvironmentSpace {
    ...
    private Long primarySpeakerDeviceId; private Long indoorSensorDeviceId; private Boolean enabled; private LocalDateTime createdAt; private LocalDateTime updatedAt;
    ...
    public Long getIndoorSensorDeviceId(){return indoorSensorDeviceId;} public void setIndoorSensorDeviceId(Long value){indoorSensorDeviceId=value;}
