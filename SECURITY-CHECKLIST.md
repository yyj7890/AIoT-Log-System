...
- [ ] 未提交 Mosquitto 密码文件（包括 `config/mosquitto-passwords` 及其变体）。
...
- [ ] `.env`、本地环境文件、`backend/src/main/resources/application.yml`、`config/mqtt-credentials.env`、本地 Mosquitto 配置和 Mosquitto 密码文件已被忽略或未进入待提交列表。
